...
#create_clock -add -name clk125 -period 8.00 -waveform {0 4} [get_ports { clk }];
...
##LEDs
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { led_0[0] }]; #IO_L23P_T3_35 Sch=led0
